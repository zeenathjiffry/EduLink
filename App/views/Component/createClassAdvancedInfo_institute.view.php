<!-- Curriculum -->
    ...
    <div class="advanced-info-container">
        ...
        <div class="media-section">
            <div class="media-item">
                ...
                <div class="upload-area">
                    ...
                    <button class="upload-btn" id="upload-thumbnail-btn">Upload Image</button>
                    <input type="file" id="thumbnail-input" accept=".png,.jpg,.jpeg,.svg" style="display: none;">
                    <img id="thumbnail-preview" alt="Preview" style="max-width: 200px; margin-top: 1rem; display: none;">
            ...
            <div class="media-item">
                ...
                <div class="upload-area">
                    ...
                    <button class="upload-btn" id="upload-video-btn">Upload Video</button>
            ...
            <div class="schedule-content">
                ...
                <div class="time-capacity">
                    <div class="time-section">
                        ...
                        <div class="time-input">
                            <input type="time" id="end-time" name="end_time" value="17:00">
                        </div>
                    </div>
        ...
        <div class="form-actions">
            <button type="button" class="btnSavedraft">Save as Draft</button>
            <button type="button" id="find-teacher-btn" class="btnAssign">Find a Teacher</button>
        </div>
    </div>
    <script src="../../../Public/assets/js/component/createClassAdvancedInfo_institute.view.js" defer></script>
